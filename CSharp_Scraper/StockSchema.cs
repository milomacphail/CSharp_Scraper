...
namespace CSharp_Scraper
{
    public class Stock
    {
        ...
        public string TimeScraped { get => _timeScraped; set => _timeScraped = value; }
        ...
        public Stock(string timeScraped, string stockSymbol, string lastPrice, string change,
